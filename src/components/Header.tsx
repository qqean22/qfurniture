...
import logoImage from "@/images/qf-logo.png";
...
function Logo() {
  return (
    <Link href="/" className="flex items-center gap-3">
      <div className="relative flex-shrink-0 h-12 w-auto" style={{ minWidth: 48 }}>
        <Image
          src={logoImage}
          alt={SITE.name}
          height={48}
          width={logoImage.width * (48 / logoImage.height)}
          className="object-contain object-left"
          priority
        />
      </div>
      <div>
        <div className="text-xl sm:text-2xl font-bold uppercase tracking-tight text-primary">
          {SITE.name}
        </div>
  ...
  return (
    <div className="flex items-center gap-6">
      ...
      <div className="flex items-center gap-3">
        <a href={SOCIAL_LINKS.facebook} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-gold" aria-label="Facebook">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
        </a>
        <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-gold" aria-label="Instagram">
        ...
        <a href={SOCIAL_LINKS.tiktok} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-gold" aria-label="TikTok">
