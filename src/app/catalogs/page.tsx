  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="border border-stone-200 p-6 bg-stone-50">
        ...
        <p className="text-sm text-stone-600 mb-4">Full product range and specifications.</p>
        <a href="#" className="inline-block px-4 py-2 bg-gold text-primary hover:bg-gold-light text-sm font-medium transition-colors">
          Download PDF
        </a>
      </div>
    </div>
