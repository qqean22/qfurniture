...
export const metadata: Metadata = {
  title: "About Us | QFurniture",
  description: "QFurniture is a market leader in the manufacturing, design, and installation of seating and interior solutions for the hospitality sector.",
};
...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      ...
      <p className="text-xl text-gray-600 mb-8">Do You Want To Know Us?</p>

      <div className="prose prose-gray max-w-none space-y-8">
        <p className="text-gray-700 leading-relaxed">
          QFurniture is a market leader in the manufacturing, design, and installation of seating and interior solutions for the hospitality sector.
        </p>
        <p className="text-gray-700 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-primary mt-12">QFurniture (QF)</h2>
        <p className="text-gray-700 leading-relaxed">
          QFurniture specializes in creating bespoke booth seating to match any colour or size requirement for shisha places. With a wide range of fabrics, stitching, and leather options, we can provide a unique design that complements your workplace.
        </p>
        <p className="text-gray-700 leading-relaxed">
        ...
        <p className="text-gray-700 leading-relaxed">
          QFurniture is able to offer clients a more streamlined and efficient process, as well as a unique design approach that emphasizes longevity and sustainability. The company&apos;s experts can provide a variety of services, including free site surveys, internal designer proposals, and full installation.
        </p>
        <p className="text-gray-700 leading-relaxed">
        ...
        <p className="text-gray-700 leading-relaxed">
          QFurniture offers a wide variety of seating options, including booth seating, bench seating, back-to-back seating, Chesterfield seating, and banquette seating. Each option is tailored to the specific needs and preferences of clients, and can be customized to match the interior design of any space.
        </p>
